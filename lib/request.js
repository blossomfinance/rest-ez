...
import  RestEZResponse from './response';

export default class RestEZRequest {
        ...
        try {
            let response = await new Promise(function (resolve, reject) {
                request(self.options, function (err, response, body) {
                    ...
                    let restEZResponse = new RestEZResponse(this, err, response, body);
                    return resolve(restEZResponse);
                });
            });
